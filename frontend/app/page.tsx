      ...
      <ToastProvider>
        ...
        <section className="sectionRose w-full h-[800px] flex items-start justify-center pr-[45%] py-[8%]">
          <div className="text-left">
            ...
            <p className="custom-font text-lg py-[8%]">
              {" "}
              Elevando seu estilo, impulsionando sua performance. <br />{" "}
              Vista-se para o sucesso com nossas roupas fitness <br />{" "}
              exclusivas.
            </p>
            <button className="button-green border border-green-800 rounded-md hover:bg-green-800 hover:text-white duration-500 text-white px-[20%] py-3 mt-2">
              Compre já
            </button>
          </div>
          <Image
            className="image-border absolute top-60 left-[60%]"
            src={imageHero}
            alt="Befit Logo"
            width={503}
            height={628}
        ...
        <p className="custom-font text-lg py-[2%]">
          {" "}
          Descubra a nova coleção que redefine a moda fitness. Encontre peças
          projetadas para elevar seu treino e seu estilo. Explore agora e
        ...
        <div className="relative py-[2%] mb-[5%]">
          ...
          <div className="inline-block relative mr-[30px] w-[375px] h-[400px] overflow-hidden">
            ...
            />
            <button className="absolute bottom-[15px] transform left-1/2 -translate-x-1/2 w-[331px] h-[62px] bg-white rounded-none hover:bg-gray-200 transition duration-500 text-black font-bold text-lg leading-[32.4px] align-middle">
              Veja
            </button>
          </div>
        ...
        <section className="sectionGreen w-full pl-[10%] py-[5%] ">
          ...
          <div className="text-left flex-1 min-w-[30%] pr-[5%]">
            ...
            <p className="custom-fontRose text-lg py-4 text-white">
              Explore Nossos Produtos Em Alta <br /> Demanda! Descubra As Peças
              Mais <br /> Populares Que Estão Elevando O Jogo Da <br /> Moda
              Fitness. Garanta O Seu Estilo E <br /> Desempenho Hoje Mesmo!
            </p>
            <button className="button-white border border-green-800 rounded-none hover:bg-green-800 hover:text-white duration-500 text-white">
              VEJA MAIS
            </button>
          </div>
            ...
            <div className="w-[375px] h-[533.5px] overflow-hidden mr-[20px] bg-white">
              ...
              <div className="flex flex-col justify-start h-[149.5px] bg-white px-10 py-10">
                <div className="flex items-center justify-start mb-2">
                  {" "}
                  {/* Alinhado à esquerda com a mesma margem */}
                ...
                <p className="text-av font-bold">Conjunto Rosa</p>
                <div className="flex justify-between items-center mt-2">
                  <div className="flex items-center">
                    <span className="text-price-before font-normal">R$</span>
                    <span className="text-price-before font-normal mx-1">
                      220
                    </span>
                    <div className="-ml-12 w-[45px] h-[1px] bg-[#9B9B9B]"></div>{" "}
                    {/* Risco horizontal */}
                    <span className="text-price font-bold ml-[10px]">
                      R$ 140
                    </span>
                  </div>
                </div>
        ...
        <nav className="flex items-center justify-center space-x-8 py-[3%]">
          <a
            href="#"
            className="custom-green hover:text-green-600 font-bold transition-colors duration-500 underline decoration-custom-green decoration-2 underline-offset-8"
          >
            EM ALTA
          </a>
          <a
            href="#"
            className="custom-green hover:text-green-600 font-normal transition-colors duration-500"
          >
            À VENDA
          </a>
          <a
        ...
        <div className="flex justify-center items-center overflow-hidden py-[3%] mb-[5%] w-[1172px]">
          <div className="inline-block relative mr-[30px] w-[275px] overflow-hidden">
            ...
            <div className="flex flex-col justify-center bg-white py-10">
              ...
              <p className="text-gr font-bold justify-center">Conjunto Rosa</p>
              <div className="flex justify-center items-center mt-2">
                <div className="flex items-center">
                  ...
                  <div className="-ml-12 w-[45px] h-[1px] bg-[#9B9B9B]"></div>{" "}
                  {/* Risco horizontal */}
                  <span className="text-price-gr font-bold ml-[10px]">
                    R$ 140
                  </span>
                </div>
              </div>
        ...
        <section className="sectionRose flex justify-between items-center w-[1175px] h-[538px]">
          <div className="text-left pl-[10%]">
            ...
            <p className="custom-font-oferta text-lg py-[2%]">
              {" "}
              Preços Baixos E Frete Grátis. Seu Momento De Brilhar <br></br> Na
              Academia!
            </p>
        ...
        <p className="custom-font text-lg">
          {" "}
          Testemunhos Reais Sobre Como Nossas Roupas Fitness Estão Transformando
          Suas Vidas.
        </p>
        ...
        <section className="sectionWhite pl-[10%] py-[5%] ">
          ...
          <div className="block">
            <div className="">
              <p className="sub-title font-bold py-[8%]">
                Motivação Elevada E Estilo Impecável!
              </p>
            </div>
            <div className="description px-[8%]">
              <p>
                Desde que comecei a usar as roupas fitness deste site, minha
                motivação para treinar aumentou consideravelmente! Além de
                confortáveis, elas são super estilosas. Recomendo a todos que
                buscam qualidade e estilo em suas peças de academia.
              </p>
            </div>
        ...
        <div className="relative">
          ...
          <div className="text-price-gr font-bold flex justify-center items-center absolute transform left-1/2 -translate-x-1/2 -translate-y-1/2 w-[463px] h-[78px] bg-white">
            NOS SIGA NO INSTAGRAM: @_lojabefit
          </div>
        </div>
